...
public class WindowsPopup {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//This code is written for Browse popup (windows popup)
		//will click on browse button and will attach the specified image. 
		String uploadimage=driver.findElement(By.id("uploadFile")).getText();
		Thread.sleep(5000);
		if (uploadimage.contains(".jpg")){
